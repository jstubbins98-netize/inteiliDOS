...
/* PC speaker — volume control (0 = silent, 100 = full, default = 50).
 * Affects both PCM playback amplitude and square-wave mute threshold. */
void     speaker_set_volume(int pct);   /* clamped to 0–100 */

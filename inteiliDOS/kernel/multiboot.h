...
/* Multiboot1 module descriptor — one entry per 'module' line in grub.cfg.
 * mods_addr in multiboot_info_t points to an array of these.             */
typedef struct {
    uint32_t mod_start;   /* physical address of module data start */
    uint32_t mod_end;     /* physical address of module data end   */
    uint32_t cmdline;     /* physical address of module string     */
